...
public class bk
{
  private static final Interpolator v = new bl();
  private int a;
  private int b;
  private int c = -1;
  private float[] d;
  ...
  private final Runnable w = new bm(this);
  
  private bk(Context paramContext, ViewGroup paramViewGroup, bn parambn)
  {
  ...
  public static bk a(ViewGroup paramViewGroup, float paramFloat, bn parambn)
  {
    paramViewGroup = a(paramViewGroup, parambn);
    paramViewGroup.b = ((int)(paramViewGroup.b * (1.0F / paramFloat)));
    return paramViewGroup;
  }
  
  public static bk a(ViewGroup paramViewGroup, bn parambn)
  {
    return new bk(paramViewGroup.getContext(), paramViewGroup, parambn);
  }
  ...
  {
    int i2 = az.c(paramMotionEvent);
    int i1 = 0;
    while (i1 < i2)
    {
      int i3 = az.b(paramMotionEvent, i1);
      float f1 = az.c(paramMotionEvent, i1);
      float f2 = az.d(paramMotionEvent, i1);
      this.f[i3] = f1;
      this.g[i3] = f2;
      i1 += 1;
    }
  ...
  private void d()
  {
    ...
    a(a(bp.a(this.l, this.c), this.n, this.m), a(bp.b(this.l, this.c), this.n, this.m));
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    return a(paramInt1, paramInt2, (int)bp.a(this.l, this.c), (int)bp.b(this.l, this.c));
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    while (this.a == 1)
    {
      ...
      if ((this.p & i2) != 0)
      {
        ...
        continue;
        i2 = az.b(paramMotionEvent, i1);
        f1 = az.c(paramMotionEvent, i1);
        f2 = az.d(paramMotionEvent, i1);
        a(f1, f2, i2);
        if (this.a == 0)
        {
          i1 = this.h[i2];
  ...
  public void b(MotionEvent paramMotionEvent)
  {
    int i1 = 0;
    int i2 = 0;
    int i4 = az.a(paramMotionEvent);
    int i3 = az.b(paramMotionEvent);
    if (i4 == 0) {
      b();
    }
    if (this.l == null) {
    ...
    case 2: 
      do
      {
        do
        {
          do
          {
            ...
            this.r.a(i2 & this.p, i1);
            return;
            i1 = az.b(paramMotionEvent, i3);
            f1 = az.c(paramMotionEvent, i3);
            f2 = az.d(paramMotionEvent, i3);
            a(f1, f2, i1);
            if (this.a != 0) {
              break;
            }
      ...
      i1 = az.a(paramMotionEvent, this.c);
      f1 = az.c(paramMotionEvent, i1);
      f2 = az.d(paramMotionEvent, i1);
...
/* Location:              /Users/sunkuo/Downloads/dex2jar-2.0/classes-dex2jar.jar!/android/support/v4/widget/bk.class
