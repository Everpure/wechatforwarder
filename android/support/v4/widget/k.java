...
class k
{
  ...
  {
    if ((paramCompoundButton instanceof bj)) {
      ((bj)paramCompoundButton).setSupportButtonTintList(paramColorStateList);
    }
  }
  ...
  {
    if ((paramCompoundButton instanceof bj)) {
      ((bj)paramCompoundButton).setSupportButtonTintMode(paramMode);
    }
  }
}


/* Location:              /Users/sunkuo/Downloads/dex2jar-2.0/classes-dex2jar.jar!/android/support/v4/widget/k.class
