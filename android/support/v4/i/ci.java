...
class ci
{
  ...
  static ColorStateList a(View paramView)
  {
    if ((paramView instanceof bo)) {
      return ((bo)paramView).getSupportBackgroundTintList();
    }
    return null;
  }
  ...
  {
    if ((paramView instanceof bo)) {
      ((bo)paramView).setSupportBackgroundTintList(paramColorStateList);
    }
  }
  ...
  {
    if ((paramView instanceof bo)) {
      ((bo)paramView).setSupportBackgroundTintMode(paramMode);
    }
  }
  ...
  {
    if ((paramView instanceof bo)) {
      return ((bo)paramView).getSupportBackgroundTintMode();
    }
    return null;
  }
...
/* Location:              /Users/sunkuo/Downloads/dex2jar-2.0/classes-dex2jar.jar!/android/support/v4/i/ci.class
