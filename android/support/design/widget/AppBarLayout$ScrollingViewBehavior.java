  ...
  extends av
{
  ...
  public AppBarLayout$ScrollingViewBehavior(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, i.ScrollingViewBehavior_Params);
    b(paramContext.getDimensionPixelSize(i.ScrollingViewBehavior_Params_behavior_overlapTop, 0));
...
/* Location:              /Users/sunkuo/Downloads/dex2jar-2.0/classes-dex2jar.jar!/android/support/design/widget/AppBarLayout$ScrollingViewBehavior.class
