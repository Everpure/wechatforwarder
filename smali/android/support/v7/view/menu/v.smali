...
.field private l:Landroid/support/v7/widget/dg;
...
.method public c()Landroid/support/v7/widget/dg;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/dg;
...
.method public d()Z
    ...
    new-instance v2, Landroid/support/v7/widget/dg;
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroid/support/v7/widget/dg;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/dg;

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/dg;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/dg;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/dg;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/dg;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/dg;

    iget-object v3, p0, Landroid/support/v7/view/menu/v;->f:Landroid/support/v7/view/menu/w;

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/dg;->a(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/dg;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/dg;->a(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/dg;->a(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/dg;

    iget v2, p0, Landroid/support/v7/view/menu/v;->r:I

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/dg;->d(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/dg;->f(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/dg;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/dg;->g(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/dg;->m()Landroid/widget/ListView;
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/dg;
