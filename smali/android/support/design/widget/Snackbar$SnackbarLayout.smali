...
.field private f:Landroid/support/design/widget/bk;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/design/i;->SnackbarLayout:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Landroid/support/design/i;->SnackbarLayout_android_maxWidth:I
    ...
    sget v1, Landroid/support/design/i;->SnackbarLayout_maxActionInlineWidth:I
    ...
    sget v1, Landroid/support/design/i;->SnackbarLayout_elevation:I
    ...
    invoke-static {p0, v1}, Landroid/support/v4/i/bu;->d(Landroid/view/View;F)V
    ...
    invoke-static {p0, v3}, Landroid/support/v4/i/bu;->d(Landroid/view/View;I)V

    invoke-static {p0, v3}, Landroid/support/v4/i/bu;->c(Landroid/view/View;I)V
...
.method private static a(Landroid/view/View;II)V
    ...
    invoke-static {p0}, Landroid/support/v4/i/bu;->w(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Landroid/support/v4/i/bu;->k(Landroid/view/View;)I

    move-result v0

    invoke-static {p0}, Landroid/support/v4/i/bu;->l(Landroid/view/View;)I

    move-result v1

    invoke-static {p0, v0, p1, v1, p2}, Landroid/support/v4/i/bu;->a(Landroid/view/View;IIII)V
...
.method b(II)V
    ...
    invoke-static {v0, v4}, Landroid/support/v4/i/bu;->c(Landroid/view/View;F)V
...
.method protected onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bk;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bk;

    invoke-interface {v0, p0}, Landroid/support/design/widget/bk;->a(Landroid/view/View;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-interface {v0, p0}, Landroid/support/design/widget/bk;->b(Landroid/view/View;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bl;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/design/widget/bl;->a(Landroid/view/View;IIII)V
...
.method setOnAttachStateChangeListener(Landroid/support/design/widget/bk;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bk;

    return-void
.end method

.method setOnLayoutChangeListener(Landroid/support/design/widget/bl;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bl;
