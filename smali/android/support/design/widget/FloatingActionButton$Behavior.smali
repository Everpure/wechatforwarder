...
# instance fields
.field private b:Landroid/support/design/widget/bx;
...
.method private c(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;Landroid/view/View;)V
    ...
    :cond_0
    invoke-static {p2}, Landroid/support/v4/i/bu;->n(Landroid/view/View;)F

    move-result v1

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bx;

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bx;

    invoke-virtual {v2}, Landroid/support/design/widget/bx;->b()Z
    ...
    invoke-virtual {v2}, Landroid/support/design/widget/bx;->e()V
    ...
    iput-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bx;

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bx;

    sget-object v3, Landroid/support/design/widget/a;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {v2, v3}, Landroid/support/design/widget/bx;->a(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/design/widget/bx;->a(Landroid/support/design/widget/bz;)V

    :cond_2
    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bx;

    invoke-virtual {v2, v1, v0}, Landroid/support/design/widget/bx;->a(FF)V

    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->b:Landroid/support/design/widget/bx;

    invoke-virtual {v1}, Landroid/support/design/widget/bx;->a()V
    ...
    :cond_3
    invoke-static {p2, v0}, Landroid/support/v4/i/bu;->b(Landroid/view/View;F)V
