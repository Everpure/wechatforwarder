...
.method private b(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    invoke-static {v5}, Landroid/support/v4/i/bu;->p(Landroid/view/View;)I
    ...
    :cond_0
    :goto_1
    invoke-static {v5}, Landroid/support/v4/i/bu;->t(Landroid/view/View;)Z
...
.method private b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)V
    ...
    iput-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/bx;

    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/bx;

    sget-object v2, Landroid/support/design/widget/a;->e:Landroid/view/animation/Interpolator;

    invoke-virtual {v1, v2}, Landroid/support/design/widget/bx;->a(Landroid/view/animation/Interpolator;)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/widget/bx;->a(Landroid/support/design/widget/bz;)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/bx;
    ...
    invoke-virtual {v2, v1}, Landroid/support/design/widget/bx;->a(I)V

    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->d:Landroid/support/design/widget/bx;

    invoke-virtual {v1, v0, p3}, Landroid/support/design/widget/bx;->a(II)V
...
.method private c(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    invoke-static {v4}, Landroid/support/v4/i/bu;->p(Landroid/view/View;)I
    ...
    invoke-static {v0, v1, v2}, Landroid/support/design/widget/aw;->a(III)I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1, p2, v0}, Landroid/support/design/widget/at;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Landroid/support/design/widget/at;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/os/Parcelable;)V
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)Z
    ...
    invoke-static {v0, v3, v1}, Landroid/support/design/widget/aw;->a(III)I
...
.method public b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
    ...
    invoke-super {p0, p1, p2}, Landroid/support/design/widget/at;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-static {v6}, Landroid/support/v4/i/bu;->p(Landroid/view/View;)I
